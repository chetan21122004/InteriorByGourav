...
export const Header = () => {
  ...
  return (
    <>
      <header className="w-full bg-primary/95 backdrop-blur-sm shadow-soft sticky top-0 z-50 border-b border-white/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <Button 
              className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold hover:scale-105 transition-transform duration-300 bg-accent hover:bg-accent-hover text-accent-foreground"
              size="sm"
            >
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-primary/98 backdrop-blur-sm border-t border-white/10">
