  ...
  return (
    <section className="py-8 md:py-12 lg:py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-primary rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 text-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6">
                Why Choose <span className="text-accent">Kumar Gaurav Interiors?</span>
              </h3>
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start md:items-center">
                  <Star className="w-5 h-5 md:w-6 md:h-6 text-accent mr-3 fill-current flex-shrink-0 mt-0.5 md:mt-0" />
                  <span className="text-sm md:text-lg leading-relaxed">15+ Years of Excellence in Interior Design</span>
                </div>
                <div className="flex items-start md:items-center">
                  <Award className="w-5 h-5 md:w-6 md:h-6 text-accent mr-3 flex-shrink-0 mt-0.5 md:mt-0" />
            ...
            <div className="text-center lg:text-right mt-6 lg:mt-0">
              <div className="inline-block bg-white/10 backdrop-blur-sm rounded-2xl p-4 md:p-6 mb-4 md:mb-6">
                <div className="text-3xl md:text-4xl font-bold text-accent mb-1 md:mb-2">4.9★</div>
