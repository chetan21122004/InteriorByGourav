              ...
              <ul className="space-y-3">
                {quickLinks.map((link, index) => (
                  <li key={index}>
                    <a 
                      href={link.href}
                      className="text-secondary hover:text-accent transition-colors duration-300 text-sm md:text-base"
                    >
                      {link.name}
                    </a>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {services.map((service, index) => (
                  <li key={index} className="text-secondary text-sm md:text-base">
                    {service}
                  </li>
                ))}
              </ul>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-secondary text-sm md:text-base">+91 8210827736</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-secondary text-sm md:text-base">kgdicky01@gmail.com</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-secondary text-sm md:text-base">Serving Across India</p>
                    <p className="text-xs text-muted-foreground">Premium interior solutions</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                <Button 
                  className="w-full md:w-auto px-6 py-3 font-semibold hover:scale-105 transition-transform duration-300 bg-accent hover:bg-accent-hover text-accent-foreground"
                >
        ...
        <div className="border-t border-white/10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex flex-wrap justify-center md:justify-end space-x-6 text-xs text-muted-foreground">
